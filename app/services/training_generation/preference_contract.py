...
CODE_GENERATION_PARSE_FAILED = "TRAINING_PLAN_GENERATION_PARSE_FAILED"
CODE_GENERATION_TRUNCATED = "TRAINING_PLAN_GENERATION_TRUNCATED"
CODE_GENERATION_SCHEMA_INVALID = "TRAINING_PLAN_GENERATION_SCHEMA_INVALID"
CODE_GENERATION_SEMANTICALLY_INVALID = "TRAINING_PLAN_GENERATION_SEMANTICALLY_INVALID"
# Sprint 11 PR4 Task 3: generation-time exercise canonicalization failures.
# Raised only after PR3 shape/semantic validation has already accepted the
# candidate plan; the catalog is the sole exercise-identity authority. These
# are closed, non-repairable categories — never provider-echoing text.
CODE_GENERATION_EXERCISE_UNRESOLVED = "TRAINING_PLAN_GENERATION_EXERCISE_UNRESOLVED"
CODE_GENERATION_EXERCISE_AMBIGUOUS = "TRAINING_PLAN_GENERATION_EXERCISE_AMBIGUOUS"
...
I18N_GENERATION_PARSE_FAILED = "plan.gen_parse_failed"
I18N_GENERATION_TRUNCATED = "plan.gen_truncated"
I18N_GENERATION_SCHEMA_INVALID = "plan.gen_schema_invalid"
I18N_GENERATION_SEMANTICALLY_INVALID = "plan.gen_semantic_invalid"
I18N_GENERATION_EXERCISE_UNRESOLVED = "plan.gen_exercise_unresolved"
I18N_GENERATION_EXERCISE_AMBIGUOUS = "plan.gen_exercise_ambiguous"
