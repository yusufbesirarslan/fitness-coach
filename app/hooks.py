...
def _csrf_protect():
    ...
    # Referer fallback only when Origin is absent (older browsers / some proxies
    # strip Origin). Referer is weaker — it can be stripped or, in rare configs,
    # spoofed — so log each Referer-only approval to surface anomalies.
